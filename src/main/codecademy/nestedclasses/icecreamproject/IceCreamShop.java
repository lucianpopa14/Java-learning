package src.main.codecademy.nestedclasses.icecreamproject;
...
public class IceCreamShop {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Thank you for your order!\nToday we have sold "+items.totalCount+" orders of sweetness!\n"+nonVegan.totalCount+" items have been" +
                " ice cream and shakes.\n"+vegan.totalCount+" items have been smoothies and slushies.");
    }
}
